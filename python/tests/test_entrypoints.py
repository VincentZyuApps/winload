...
class EntrypointTests(unittest.TestCase):
    def test_installed_prerelease_version_uses_project_spelling(self):
        with patch("winload.diagnostics.get_pkg_version", return_value="0.2.0a3"):
            self.assertEqual(get_version(), "0.2.0-alpha.3")
    ...
    def test_python_module_version(self):
        ...
        self.assertIn("winload 0.2.0-alpha.3 (Python edition)", result.stdout)
