...
class EntrypointTests(unittest.TestCase):
    def test_installed_prerelease_version_uses_project_spelling(self):
        with patch("winload.diagnostics.get_pkg_version", return_value="0.1.13a1"):
            self.assertEqual(get_version(), "0.1.13-alpha.1")
    ...
    def test_python_module_version(self):
        ...
        self.assertIn("winload 0.1.13-alpha.1 (Python edition)", result.stdout)
